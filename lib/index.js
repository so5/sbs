...
class SBS extends EventEmitter {
  ...
  async _dispatch() {
    ...
    ++this.numRunning;
    //job and id can be null if queue is empty.
    //But in this case, this._toGo() return false and never come to here
    ...
    const maxRetry = job.hasOwnProperty("maxRetry") ? job.maxRetry : this.maxRetry
